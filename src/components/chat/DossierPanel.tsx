  ...
  const load = async () => {
    ...
    if (data) {
      setDossier({
        ...
        patterns: (data.patterns as Item[]) ?? [],
        themes: (data.themes as Item[]) ?? [],
        triggers: (data.triggers as Item[]) ?? [],
        resources: (data.resources as Item[]) ?? [],
        values_list: (data.values_list as Item[]) ?? [],
        goals: (data.goals as Item[]) ?? [],
        relationships: (data.relationships as Item[]) ?? [],
        notes: data.notes ?? "",
